...
assert.match(styles, /\.tm-kanban\.tm-kanban--clean \.tm-kanban-subtask-row-main,\s*\.tm-whiteboard\.tm-kanban--clean \.tm-kanban-subtask-row-main\s*\{\s*align-items:\s*center;/, 'kanban and whiteboard subtask contents must share the vertically centered single-line layout');
assert.match(styles, /\.tm-kanban\.tm-kanban--clean \.tm-kanban-subtask-row-main > \.tm-task-checkbox-wrap,\s*\.tm-kanban\.tm-kanban--clean \.tm-kanban-subtask-row-main > \.tm-task-checkbox-wrap \.tm-task-checkbox,\s*\.tm-whiteboard\.tm-kanban--clean \.tm-kanban-subtask-row-main > \.tm-task-checkbox-wrap,\s*\.tm-whiteboard\.tm-kanban--clean \.tm-kanban-subtask-row-main > \.tm-task-checkbox-wrap \.tm-task-checkbox\s*\{\s*margin-top:\s*0;/, 'kanban and whiteboard subtask checkbox wrappers and inputs must not retain the font-size offset while their row is vertically centered');
assert.match(
    styles,
