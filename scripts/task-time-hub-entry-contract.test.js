...
const quickAddSource = read('src', 'task-horizon', 'main', 'task-runtime', '53b-task-create-and-quick-add-runtime.js');
const createServiceSource = read('src', 'task-horizon', 'main', '20-api-and-runtime-services.js');
...
assert.doesNotMatch(quickAddSource, /tmQuickAddReminderBtn|tmQuickAddToggleReminder/, 'quick add must not keep a duplicate reminder control outside the shared time hub');
