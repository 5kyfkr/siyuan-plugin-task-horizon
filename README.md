...
使用说明：
[\[js\] 任务管理器插件 V1.3 发布：新增日历视图，支持：看板/ 时间轴 / 表格视图 / 四象限分组 / 悬浮条快速编辑 / 任务快速新建 / 自定义优先级排序 / 番茄钟联动](https://ld246.com/article/1770607439695)
视图介绍：
[\[js\] 任务管理器插件 V1.5发布：支持白板视图，附时间轴、看板、日历、表格 视图使用介绍](https://ld246.com/article/1770607439695)
